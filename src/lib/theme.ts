...
export const themeFontMap: Record<ThemeType, string> = {
  'minimal-light': '"ThemeNumberNeoBrutalPop", sans-serif',
  claymorph: '"ThemeNumberClaymorph", sans-serif',
  'soft-bloom': '"ThemeNumberSoftBloom", sans-serif',
  'lavender-violet': '"ThemeNumberClaymorph", sans-serif',
  'purple-peach': '"ThemeNumberPurplePeach", sans-serif',
  'mint-gray': '"ThemeNumberMintGray", sans-serif',
  'soft-pink-beige': '"ThemeNumberSoftPinkBeige", sans-serif',
  'neon-lime': '"ThemeNumberNeonLime", sans-serif',
  'cyan-navy': '"ThemeNumberCyanNavy", sans-serif',
  'electric-blue': '"ThemeNumberElectricBlue", sans-serif',
  'amber-charcoal': '"ThemeNumberAmberCharcoal", serif',
  'graphite-green': '"ThemeNumberGraphiteGreen", sans-serif',
...
export const themes: Record<ThemeType, ThemeDefinition> = {
  'neon-lime': {
    ...
    fontFamily: themeFontMap['neon-lime'],
    mode: 'dark',
  ...
  'cyan-navy': {
    ...
    fontFamily: themeFontMap['cyan-navy'],
    mode: 'dark',
  ...
  'electric-blue': {
    ...
    fontFamily: themeFontMap['electric-blue'],
    mode: 'dark',
  ...
  'amber-charcoal': {
    ...
    fontFamily: themeFontMap['amber-charcoal'],
    mode: 'dark',
  ...
  'graphite-green': {
    ...
    fontFamily: themeFontMap['graphite-green'],
    mode: 'dark',
  ...
  'minimal-light': {
    ...
    fontFamily: themeFontMap['minimal-light'],
    mode: 'light',
  ...
  claymorph: {
    ...
    fontFamily: themeFontMap.claymorph,
    mode: 'light',
  ...
  'soft-bloom': {
    ...
    fontFamily: themeFontMap['soft-bloom'],
    mode: 'light',
  ...
  'orange-noir': {
    ...
    fontFamily: themeFontMap['orange-noir'],
    mode: 'dark',
  ...
  'neo-brutal-pop': {
    ...
    fontFamily: themeFontMap['neo-brutal-pop'],
    mode: 'dark',
  ...
  'royal-amethyst': {
    ...
    fontFamily: themeFontMap['royal-amethyst'],
    mode: 'dark',
  ...
  'lavender-violet': {
    ...
    fontFamily: themeFontMap['lavender-violet'],
    mode: 'light',
  ...
  'purple-peach': {
    ...
    fontFamily: themeFontMap['purple-peach'],
    mode: 'light',
  ...
  'mint-gray': {
    ...
    fontFamily: themeFontMap['mint-gray'],
    mode: 'light',
  ...
  'soft-pink-beige': {
    ...
    fontFamily: themeFontMap['soft-pink-beige'],
    mode: 'light',
