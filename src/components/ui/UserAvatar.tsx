...
export default function UserAvatar({ className, size = 44 }: UserAvatarProps) {
  ...
  const modeShadow = themeConfig.mode === 'dark'
    ? '0 0 0 1px color-mix(in srgb, var(--border-strong) 72%, transparent), 0 0 26px color-mix(in srgb, var(--primary) 22%, transparent)'
    : '0 0 0 1px color-mix(in srgb, var(--border-strong) 68%, white), 0 14px 28px color-mix(in srgb, var(--primary) 18%, transparent)';
      ...
      <svg viewBox="0 0 128 128" className="h-full w-full" fill="none">
        <defs>
          <linearGradient id={`${id}-bg`} x1="18" y1="16" x2="108" y2="112" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor={themeConfig.colors.secondary} />
            <stop offset="0.52" stopColor={themeConfig.colors.primary} />
            <stop offset="1" stopColor={themeConfig.colors.accent} />
          </linearGradient>
          <linearGradient id={`${id}-jacket`} x1="20" y1="74" x2="110" y2="118" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor={themeConfig.colors.surfaceHighlight} />
            <stop offset="1" stopColor={themeConfig.colors.text} />
          </linearGradient>
          <pattern id={`${id}-dots`} width="10" height="10" patternUnits="userSpaceOnUse">
            <circle cx="2" cy="2" r="1.2" fill={themeConfig.colors.text} opacity="0.18" />
            <circle cx="8" cy="6" r="1.2" fill={themeConfig.colors.text} opacity="0.1" />
          </pattern>
          <clipPath id={`${id}-clip`}>
        ...
        <g clipPath={`url(#${id}-clip)`}>
          ...
          <path
            ...
            stroke={themeConfig.colors.textInverse}
            strokeWidth="4"
          ...
          <path
            ...
            strokeLinejoin="round"
          />
          <rect x="56" y="74" width="16" height="18" rx="8" fill={themeConfig.colors.primarySoft} />
          <path
          ...
          <path
            ...
            fill={themeConfig.colors.primarySoft}
          />
          <path
          ...
          <path
            ...
            strokeLinecap="round"
          />
          <rect x="49" y="54" width="13" height="11" rx="4" stroke={themeConfig.colors.textInverse} strokeWidth="3" />
          <rect x="69" y="54" width="13" height="11" rx="4" stroke={themeConfig.colors.textInverse} strokeWidth="3" />
          <path d="M62 59H69" stroke={themeConfig.colors.textInverse} strokeWidth="3" strokeLinecap="round" />
          <path d="M56 69L60 71" stroke={themeConfig.colors.textInverse} strokeWidth="3" strokeLinecap="round" />
          <path d="M74 69L78 71" stroke={themeConfig.colors.textInverse} strokeWidth="3" strokeLinecap="round" />
          <path d="M61 75C64 77 69 77 73 75" stroke={themeConfig.colors.textInverse} strokeWidth="3" strokeLinecap="round" />
          <path
